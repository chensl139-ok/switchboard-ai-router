...
test('生成过程中输入框保持可编辑，草稿不被清空，发送暂不可用',()=>{
 const ids=['lab-model','lab-transport','lab-thinking','lab-max-tokens','lab-clear','lab-send','lab-tools','lab-image-button','lab-image-input','lab-prompt','lab-stop','lab-compose-hint','lab-state'];
