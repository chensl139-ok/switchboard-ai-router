...
test('TTFT 从请求开始到首个输出计时，忽略角色与用量帧',()=>{
 ...
 clock=1320;assert.deepEqual(timing.finish(5),{durationMs:320,ttft:120,blocks:3,tpot:50,tps:25});
});
