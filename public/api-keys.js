...
export async function renderApiKeys({api,esc,toast}){
 ...
 container.innerHTML=`<div class="heading"><div><div class="eyebrow">ACCESS & USAGE</div><h1>对外 API Key 管理</h1><p>为每个应用单独签发密钥，控制调用次数与有效期；新 Key 自动归属创建人。</p></div><button id="new-key" class="primary">＋ 创建 API Key</button></div>
