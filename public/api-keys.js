...
export async function renderApiKeys({api,esc,toast}){
 ...
 container.innerHTML=`<div class="heading key-page-heading"><div><div class="eyebrow">ACCESS & USAGE</div><h1>对外 API Key 管理</h1><p>为每个应用单独签发密钥，控制调用次数与有效期；新 Key 自动归属创建人。</p></div><div class="heading-actions key-heading-actions"><input type="search" id="key-search" placeholder="搜索名称 / 预览 / ID" aria-label="搜索密钥"><button id="new-key" class="primary">＋ 创建 API Key</button></div></div>
