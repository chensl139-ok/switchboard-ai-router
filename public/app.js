...
document.querySelector('#provider-form [name="models"]').closest('label').insertAdjacentHTML('afterend','<label>模型计费渠道（每行：模型 ID = subscription / metered；未列出默认 Subscription）<textarea name="modelChannels" rows="3" placeholder="claude-haiku-4-5 = metered"></textarea></label>');
